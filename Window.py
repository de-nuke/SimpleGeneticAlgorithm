...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.log_label.setGeometry(QtCore.QRect(21, 278, 151, 31))
        font = QtGui.QFont()
        ...
        self.pop_size.setMinimum(2)
        self.pop_size.setMaximum(1000)
        self.pop_size.setSingleStep(2)
        ...
        self.mutate_prob.setSuffix("")
        self.mutate_prob.setDecimals(4)
        ...
        self.label_2.setGeometry(QtCore.QRect(171, 288, 201, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.max_all_time_label = QtWidgets.QLabel(self.centralwidget)
        self.max_all_time_label.setGeometry(QtCore.QRect(380, 290, 211, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.max_all_time_label.setFont(font)
        self.max_all_time_label.setObjectName("max_all_time_label")
        self.draw_plots = QtWidgets.QCheckBox(self.centralwidget)
        self.draw_plots.setGeometry(QtCore.QRect(20, 250, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.draw_plots.setFont(font)
        self.draw_plots.setIconSize(QtCore.QSize(16, 16))
        self.draw_plots.setChecked(True)
        self.draw_plots.setObjectName("draw_plots")
        ...
        self.label_4.setGeometry(QtCore.QRect(380, 260, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.found_max = QtWidgets.QLabel(self.centralwidget)
        self.found_max.setGeometry(QtCore.QRect(520, 220, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.found_max.setFont(font)
        self.found_max.setObjectName("found_max")
        self.found_max_for = QtWidgets.QLabel(self.centralwidget)
        self.found_max_for.setGeometry(QtCore.QRect(520, 250, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.found_max_for.setFont(font)
        self.found_max_for.setObjectName("found_max_for")
        self.function_input = QtWidgets.QLineEdit(self.centralwidget)
        self.function_input.setEnabled(False)
        self.function_input.setGeometry(QtCore.QRect(80, 720, 391, 31))
        font = QtGui.QFont()
        ...
        self.lineEdit.setGeometry(QtCore.QRect(20, 720, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(20, 750, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(290, 750, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_5.setFont(font)
        self.lineEdit_5.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.x_start = QtWidgets.QSpinBox(self.centralwidget)
        self.x_start.setEnabled(False)
        self.x_start.setGeometry(QtCore.QRect(110, 750, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.x_start.setMinimum(-1000)
        self.x_start.setMaximum(1000)
        self.x_start.setProperty("value", -1)
        self.x_start.setObjectName("x_start")
        self.x_end = QtWidgets.QSpinBox(self.centralwidget)
        self.x_end.setEnabled(False)
        self.x_end.setGeometry(QtCore.QRect(390, 750, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.x_end.setMinimum(-1000)
        self.x_end.setMaximum(1000)
        self.x_end.setProperty("value", 41)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Maximum value of all time: "))
        self.max_all_time_label.setText(_translate("MainWindow", "0"))
        self.draw_plots.setText(_translate("MainWindow", "Draw plots"))
        self.label_3.setText(_translate("MainWindow", "Found maximum: "))
        self.label_4.setText(_translate("MainWindow", "for x ="))
        self.found_max.setText(_translate("MainWindow", "---"))
        self.found_max_for.setText(_translate("MainWindow", "---"))
        self.function_input.setText(_translate("MainWindow", "-0.1*x**2 + 4*x + 7"))
        self.lineEdit.setText(_translate("MainWindow", "f(x) = "))
        self.lineEdit_4.setText(_translate("MainWindow", "początek: "))
        self.lineEdit_5.setText(_translate("MainWindow", "koniec:"))
